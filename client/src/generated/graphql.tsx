...
export type CreatePostMutation = (
  ...
  & { createPost: (
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'title' | 'createdAt' | 'body' | 'points' | 'opId' | 'subId'>
  ) }
);
...
export type UpdatePostMutation = (
  ...
  & { updatePost?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'title' | 'body' | 'bodySnippet' | 'updatedAt'>
  )> }
);
...
export type PostQuery = (
  ...
  & { post?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'title' | 'points' | 'createdAt' | 'body' | 'voteStatus' | 'subId'>
    & { originalPoster?: Maybe<(
      { __typename?: 'User' }
...
export type PostsQuery = (
  ...
  & { posts: (
    ...
    & { posts: Array<(
      { __typename?: 'Post' }
      & Pick<Post, 'title' | 'bodySnippet' | 'voteStatus' | 'id' | 'createdAt' | 'updatedAt' | 'points'>
      & { originalPoster?: Maybe<(
        { __typename?: 'User' }
        & Pick<User, 'id' | 'username'>
      )> }
